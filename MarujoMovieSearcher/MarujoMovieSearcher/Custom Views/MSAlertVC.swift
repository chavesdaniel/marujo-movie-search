...
class MSAlertVC: UIViewController {
    ...
    func configureTitleLabel() {
        ...
        titleLabel.text = self.alertTitle ?? "Alguma coisa deu errado"
    ...
    func configureActionButton() {
        ...
        actionButton.setTitle(self.buttonTitle ?? "OK", for: .normal)
    ...
    func configureMessageLabel() {
        ...
        messageLabel.text           = message ?? "Problema ao carregar as informações"
